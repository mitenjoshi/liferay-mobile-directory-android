...
import com.rivetlogic.mobilepeopledirectory.component.RoundedTransformation;
...
public class PeopleDirectoryListAdapter extends BaseAdapter implements Filterable {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.pointer = (ImageView) convertView.findViewById(R.id.lr_list_row_directory_pointer);
